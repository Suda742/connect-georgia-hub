    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <p className="text-body-secondary text-center mb-8 georgian-text">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {companies.map((company, index) => (
              ...
              >
                ...
                <span className="text-body-primary font-semibold georgian-text">{company.name}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-start mb-4">
                ...
                <div className="flex-1">
                  <p className="text-body-primary leading-relaxed mb-4 georgian-text">
                    "{testimonial.content}"
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-headline font-semibold text-gray-900 georgian-text">{testimonial.name}</div>
                  <div className="text-body-secondary georgian-text">{testimonial.role}</div>
                </div>
              </div>
            </div>
          ))}
